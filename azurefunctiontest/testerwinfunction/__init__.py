...
#from modelutils import get_possible_dict

def init():
    
    global model
    model = joblib.load('testerwinfunction/model.pkl')
...
def main(req: func.HttpRequest):
    ...
    abbrs = parsed_data['abbrs']

    output = {}
    vectorizer=joblib.load('testerwinfunction/vectorizer.pkl')

    for a in abbrs:
        celn = get_possible_dict(model, vectorizer, a)
        output[a] = celn
